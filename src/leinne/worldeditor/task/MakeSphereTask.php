                    ...
                    if (++$this->pos->z > $this->radius) {
                        ...
                        if (++$this->pos->y > $this->radius) {
                            if ($this->player !== null && !$this->player->isClosed()) {
                                $this->player->sendMessage(WorldEditor::$prefix . "구 생성이 완료되었습니다");
                            } elseif ($this->player !== null) {
                                Server::getInstance()->getLogger()->info(WorldEditor::$prefix . ($this->player !== null ? "{$this->player->getName()}님이 명령햔 " : "") . "구 생성이 완료되었습니다");
                            }
                            break;
                        }
                    }
